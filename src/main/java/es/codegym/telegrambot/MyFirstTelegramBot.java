...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "GatitoChatBot_bot";
    public static final String TOKEN = "6762103258:AAFwE81DACstHO4K_JeD0c513FWQjr7lebI";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if(getCallbackQueryButtonKey().equals("step_3_btn")){
            ...
            sendTextMessageAsync(STEP_4_TEXT,
                    Map.of("Enviar al robot aspirador apor comida!, +30 de fama","step_4_btn",
        ...
        if(getCallbackQueryButtonKey().equals("step_4_btn")){
            ...
            sendTextMessageAsync(STEP_5_TEXT,
                    Map.of("Pontela y encendela!", "step_5_btn"));
        }
        if(getCallbackQueryButtonKey().equals("step_5_btn")){
            addUserGlory(40);
            sendPhotoMessageAsync("step_6_pic");
            sendTextMessageAsync(STEP_6_TEXT,
                    Map.of("Grabate por los tejados!, +40 de fama","step_6_btn",
        ...
        if(getCallbackQueryButtonKey().equals("step_6_btn")){
            ...
            sendTextMessageAsync(STEP_7_TEXT,
                    Map.of("Hackea la contraseña!","step_7_btn"));
        }
